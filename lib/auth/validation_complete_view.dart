...
class ValidationCompletView extends StatefulWidget {
  const ValidationCompletView({super.key});

  @override
  State<ValidationCompletView> createState() => _ValidationCompletViewState();
}

class _ValidationCompletViewState extends State<ValidationCompletView> {
  int selectedValue = 1;
  @override
