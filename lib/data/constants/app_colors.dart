...
class AppColors {
  // Primary & Secondary.
  static const Color kPrimary = Color(0xFFF1862F);
  static const Color kSecondary = Color(0xFF110903);
  static const Color kTertiaire = Color(0xFF352E29);
  static const Color kSecondarywithOpacity5 = Color(0xE4110903);
  static const Color ksignInputBg = Color(0xFF352E29);
  static const Color ksignInputPlaceholdColor = Color(0x7EFFFFFF);
  ...
  // Gradients.
  static LinearGradient customOnboardingGradient = const LinearGradient(
